...
import { doCreateUserWithEmailAndPassword, handleGoogleClick } from '../context/Auth';
            ...
            <main>
                ...
                <form onSubmit={onSubmit}>
                    <div className='flex flex-col justify-center items-center mt-8 gap-4'>
                        ...
                        <div>
                            <button type='submit' disabled={isRegistering} className='rounded h-10 w-80 bg-green-600 px-4 py-2'>
                        ...
                        <button
                            ...
                            className={`w-80 flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-sm font-medium  ${isRegistering ? 'cursor-not-allowed' : 'hover:bg-gray-100 transition duration-300 active:bg-gray-100'}`}>
