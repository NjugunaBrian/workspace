...
function FindSearch() {
  ...
  return (
    <>
      <section className='px-2 md:px-32 py-12'>
        <div className='text-center my-0 mx-3 md:max-w-48 px-3 leading-6'>
        ...
        <div className='flex justify-center items-center mt-20 gap-1 md:gap-6'>
          <div className='bg-green-600 flex justify-center items-center rounded outline-none p-1 md:p-2 border-solid border-[#ccd7e6] border-[1px]'>
            <IoLocationOutline />
            <input className='placeholder:text-black bg-transparent outline-none mx-1 md:mx-2 w-40' type="text" placeholder='Search location' />
          </div>
          <div className='rounded outline-none px-1 md:px-4 py-2 font-light border-solid border-[#ccd7e6] border-[1px]'>
            <input
