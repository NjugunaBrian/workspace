        ...
        <>
            <section>
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-col mx-0 my-auto md:text-center max-w-6xl mb-12 md:mb-16 leading-6 text-zinc-900'>
                        <img className='h-auto w-12 m-auto mb-3' src={modelOffice} alt="office_png"/>
                        <p className='px-10 md:px-40 whitespace-break-spaces'>We work together with the best providers of work offices.
